...
void lrtmidi_async_lock_init(Lock* lock)
{
...
void lrtmidi_async_lock_destruct(Lock* lock)
{
#if defined(LRTMIDI_ASYNC_USE_PTHREAD)
...
void lrtmidi_async_mutex_init(Mutex* mutex)
{
#if defined(LRTMIDI_ASYNC_USE_PTHREAD)
...
void lrtmidi_async_mutex_destruct(Mutex* mutex)
{
#if defined(LRTMIDI_ASYNC_USE_PTHREAD)
...
void lrtmidi_async_mutex_wait(Mutex* mutex) 
{
#if defined(LRTMIDI_ASYNC_USE_PTHREAD)
...
bool lrtmidi_async_mutex_wait_millis(Mutex* mutex, int timeoutMillis)
{
#if defined(LRTMIDI_ASYNC_USE_PTHREAD)

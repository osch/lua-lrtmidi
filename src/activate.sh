# Activations script for add the lrtmidi module to the lua path when
# building lrtmidi using the Makefile.
...
if [ ! -e "$lualrtmidi_dir/src/activate.sh" -o ! -e "$lualrtmidi_dir/src/main.cpp" ]; then

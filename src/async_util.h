...
#ifndef LRTMIDI_ASYNC_UTIL_H
#define LRTMIDI_ASYNC_UTIL_H
...
#elif defined(LRTMIDI_ASYNC_USE_STDATOMIC)
typedef atomic_int      AtomicCounter;
typedef atomic_intptr_t AtomicPtr;
#elif defined(LRTMIDI_ASYNC_USE_GNU)
...
#elif defined(LRTMIDI_ASYNC_USE_WINTHREAD)
typedef DWORD ThreadId;
#elif defined (LRTMIDI_ASYNC_USE_STDTHREAD)
...
#define async_lock_init lrtmidi_async_lock_init
void async_lock_init(Lock* lock);

/* -------------------------------------------------------------------------------------------- */

#define async_lock_destruct lrtmidi_async_lock_destruct
...
#define async_mutex_init lrtmidi_async_mutex_init
void async_mutex_init(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_destruct lrtmidi_async_mutex_destruct
...
#define async_mutex_wait lrtmidi_async_mutex_wait
void async_mutex_wait(Mutex* mutex);

/* -------------------------------------------------------------------------------------------- */

#define async_mutex_wait_millis lrtmidi_async_mutex_wait_millis
